...
def month_numbering(data):
    ...
    data.to_csv('Data_retrieval\data\Watches\Rolex DateJust 126334 Price History.csv', index=False) # Change path if needed
...
# missing_data_2 = pd.DataFrame({'date': missing_dates_2, 'Rolex 126334 (EUR)': desired_price_2})
...
# missing_data_3 = pd.DataFrame({'date': missing_dates_3, 'Rolex 126334 (EUR)': desired_price_3})

# desired_price_4 = 19608
# missing_dates_4 = pd.date_range(start='2013-06-23', end='2014-06-11', freq='D')
# missing_data_4 = pd.DataFrame({'date': missing_dates_4, 'Rolex 126334 (EUR)': desired_price_4})

# desired_price_5 = 20313
# missing_dates_5 = pd.date_range(start='2014-06-12', end='2015-11-09', freq='D')
# missing_data_5 = pd.DataFrame({'date': missing_dates_5, 'Rolex 126334 (EUR)': desired_price_5})

# desired_price_6 = 34715
# missing_dates_6 = pd.date_range(start='2015-11-10', end='2016-03-16', freq='D')
# missing_data_6 = pd.DataFrame({'date': missing_dates_6, 'Rolex 126334 (EUR)': desired_price_6})

# desired_price_7 = 22530
# missing_dates_7 = pd.date_range(start='2016-03-17', end='2016-12-06', freq='D')
# missing_data_7 = pd.DataFrame({'date': missing_dates_7, 'Rolex 126334 (EUR)': desired_price_7})

# desired_price_8 = 44253
# missing_dates_8 = pd.date_range(start='2016-12-07', end='2017-05-15', freq='D')
# missing_data_8 = pd.DataFrame({'date': missing_dates_8, 'Rolex 126334 (EUR)': desired_price_8})

# desired_price_9 = 51404
# missing_dates_9 = pd.date_range(start='2017-05-16', end='2017-12-07', freq='D')
# missing_data_9 = pd.DataFrame({'date': missing_dates_9, 'Rolex 126334 (EUR)': desired_price_9})

# desired_price_10 = 37111
# missing_dates_10 = pd.date_range(start='2017-12-08', end='2018-03-22', freq='D')
# missing_data_10 = pd.DataFrame({'date': missing_dates_10, 'Rolex 126334 (EUR)': desired_price_10})

# desired_price_11 = 38583
# missing_dates_11 = pd.date_range(start='2018-03-23', end='2018-06-13', freq='D')
# missing_data_11 = pd.DataFrame({'date': missing_dates_11, 'Rolex 126334 (EUR)': desired_price_11})

# desired_price_12 = 42423
# missing_dates_12 = pd.date_range(start='2018-06-14', end='2018-12-06', freq='D')
# missing_data_12 = pd.DataFrame({'date': missing_dates_12, 'Rolex 126334 (EUR)': desired_price_12})

# desired_price_13 = 41770
# missing_dates_13 = pd.date_range(start='2018-12-07', end='2019-02-05', freq='D')
# missing_data_13 = pd.DataFrame({'date': missing_dates_13, 'Rolex 126334 (EUR)': desired_price_13})
...
"""Filling in Rolex Datejust 126334""" 
